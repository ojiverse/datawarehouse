...
| [0015](0015-json-schema-cross-language-contract.md) | **JSON Schema cross-language contract** | Observation Envelope の wire contract を JSON Schema + fixture に統一し、Protobuf は RPC 責務へ分離 | 承認（Accepted） |
